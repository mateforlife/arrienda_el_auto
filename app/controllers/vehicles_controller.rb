class VehiclesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @vehicle.save
        format.html { redirect_to @vehicle, notice: 'El vehículo fue creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @vehicle.update(vehicle_params)
        format.html { redirect_to @vehicle, notice: 'El vehículo fue actualizado exitosamente.' }
  ...
  def destroy
    @vehicle.destroy
    respond_to do |format|
      format.html { redirect_to vehicles_url, notice: 'El vehículo fue eliminado exitosamente.' }
